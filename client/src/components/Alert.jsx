...
export const Alert = () => {
  ...
  switch (type) {
    case 400:
      return (
        <div style={{ top: "80%", left: "0", right: "0" }} className="fixed bg-red-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto w-3/4 xl:w-2/4 page-enter">
          <svg
            viewBox="0 0 24 24"
    ...
    case 300:
      return (
        <div style={{ top: "80%", left: "0", right: "0" }} className="bg-yellow-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto w-3/4 xl:w-2/4 page-enter">
    ...
    case "info":
      return (
        <div style={{ top: "80%", left: "0", right: "0" }} className="bg-blue-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto w-3/4 xl:w-2/4 page-enter">
          <svg
            viewBox="0 0 24 24"
    ...
    default:
      return (
        <div style={{ top: "80%", left: "0", right: "0" }} className="fixed bg-green-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto w-3/4 xl:w-2/4 page-enter">
          <svg
            viewBox="0 0 24 24"
